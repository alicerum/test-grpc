...
type GreetingClient interface {
	Hello(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *greetingClient) Hello(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type GreetingServer interface {
	Hello(context.Context, *UserInfo) (*Response, error)
...
func (UnimplementedGreetingServer) Hello(context.Context, *UserInfo) (*Response, error) {
...
func _Greeting_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetingServer).Hello(ctx, req.(*UserInfo))
	}
